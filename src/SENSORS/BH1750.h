...
#define BH1750_ADDRESS 0x23 // Change to 0x5C if ADDR pin is high
...
{
  i2c_start();
  i2c_send_address(BH1750_ADDRESS, true);  // Write mode
...
uint16_t bh1750_read_lux()
{
  ...
  i2c_start();
  i2c_send_address(BH1750_ADDRESS, false);  // Read mode
